  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 pt-28 md:px-8">
      <div className="flex gap-4 sm:gap-5">
        <Skeleton className="size-24 rounded-full bg-neutral-500 sm:size-28" />
        <div className="flex flex-col gap-2">
          <Skeleton className="h-7 w-40 bg-neutral-500 sm:h-9 sm:w-56" />
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <Skeleton className="h-5 w-5 rounded-full bg-neutral-500" />
            <Skeleton className="mt-1 h-5 w-40 bg-neutral-500 sm:w-56" />
          </div>
          <Skeleton className="mt-3 h-6 w-20 bg-neutral-500 sm:w-24" />
        </div>
      </div>

      <div className="my-10 border-1 border-neutral-800 sm:my-12" />

      <Skeleton className="mb-5 h-7 w-28 bg-neutral-500 sm:h-8 sm:w-32" />
      ...
      <div className="grid grid-cols-2 gap-4 sm:gap-5 lg:grid-cols-4">
        {[0, 1, 2, 3].map((i) => (
          ...
          >
            <Skeleton className="h-4 w-24 bg-neutral-500 sm:w-28" />
      ...
      <Card className="my-10 p-4 sm:p-6">
        <Skeleton className="h-6 w-40 bg-neutral-500 sm:w-48" />
        <Skeleton className="mt-2 h-4 w-56 bg-neutral-500 sm:w-72" />
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        {[0, 1].map((i) => (
          <Card key={i} className="p-4 sm:p-6">
            <Skeleton className="mx-auto mb-3 h-6 w-40 bg-neutral-500 sm:w-52" />
