...
const BookmarkPage = () => {
  ...
  const movies = useMemo(() => {
    if (!filteredBookmarks || !filteredBookmarks.length) return [];
    let filteredMovies = filteredBookmarks.filter(
  ...
  const tvs = useMemo(() => {
    if (!filteredBookmarks || !filteredBookmarks.length) return [];
    let filteredTvs = filteredBookmarks.filter(
          ...
          <p>
            ...
            {mediaType === "movie" && genre !== "0"
              ...
              : mediaType === "tv" && genre !== "0"
                ...
                : ""}{" "}
            {mediaType === "movie" ? "movies" : "TV shows"} to your "
            {formatToText(bookmarkValue)}" bookmark.
