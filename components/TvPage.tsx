...
const TvPage = () => {
  ...
  const categories = [
    { label: "Most Popular", value: "popular", param: "" },
    {
      label: "Coming Soon",
      value: "coming_soon",
      param: `first_air_date.gte=${coming_soon_start}&first_air_date.lte=${coming_soon_end}`,
    },
    {
      label: "Now Streaming",
      value: "streaming",
      param: `watch_region=US&with_watch_providers=8|9|337&first_air_date.gte=${streaming_start}&first_air_date.lte=${streaming_end}`,
    },
    {
      label: "Top Rated",
      value: "top_rated",
  ...
  const {
    data: { searchResults: tvs, totalPages },
    isLoading,
  } = useTvs(param, page);
